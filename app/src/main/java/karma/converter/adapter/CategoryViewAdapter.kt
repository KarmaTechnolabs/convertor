...
import karma.converter.databinding.ItemCategoryBinding
import karma.converter.listeners.ItemClickListener
import java.util.*

class CategoryViewAdapter(context: Context?) :
    BaseAdapter<UnitItemModel,CategoryViewAdapter.ViewHolder?>(context),
    Filterable {
