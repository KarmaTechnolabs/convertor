...
class DegreeActivity: BaseActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.header.toolbar.text = resources.getString(R.string.angle)
        ...
        viewModel.weightResponse.observe(this) {
            ...
            if (it.conversionValue != "") {
                unitActivityList.add(UnitActivityModelResponse("rad", (it.conversionValue.trim().toDouble() *0.0174533).toString()))
                unitActivityList.add(UnitActivityModelResponse("mrad", (it.conversionValue.trim().toDouble()*17.4533).toString()))
                unitActivityList.add(UnitActivityModelResponse("′", (it.conversionValue.trim().toDouble() * 60).toString()))
                unitActivityList.add(UnitActivityModelResponse("″", (it.conversionValue.trim().toDouble()*3600).toString()))
            } else {
                unitActivityList.add(UnitActivityModelResponse("rad", ""))
                unitActivityList.add(UnitActivityModelResponse("mrad", ""))
                unitActivityList.add(UnitActivityModelResponse("′", ""))
                unitActivityList.add(UnitActivityModelResponse("″", ""))
            }
            ...
            callback = object : PickerLayoutManager.OnItemSelectedListener {
                override fun onItemSelected(layoutPosition: Int) {
                    ...
                    if(layoutPosition == 0) {
                        ...
                        viewModel.weightResponse.observe(this@DegreeActivity) {
                            ...
                            unitActivityAdapter?.clear()
                            unitActivityAdapter?.setClickListener(this@DegreeActivity)
                            binding.unitRecycler.adapter = unitActivityAdapter
                            unitActivityAdapter?.setItems(unitActivityList)
                        ...
                        viewModel.weightResponse.observe(this@DegreeActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("°", (it.conversionValue.trim().toDouble() *57.2958).toString()))
                                unitActivityList.add(UnitActivityModelResponse("mrad", (it.conversionValue.trim().toDouble()*1000).toString()))
                                unitActivityList.add(UnitActivityModelResponse("′", (it.conversionValue.trim().toDouble() * 3437.75).toString()))
                                unitActivityList.add(UnitActivityModelResponse("″", (it.conversionValue.trim().toDouble()*206265).toString()))
                        ...
                        viewModel.weightResponse.observe(this@DegreeActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("°", (it.conversionValue.trim().toDouble() *0.0572958).toString()))
                                unitActivityList.add(UnitActivityModelResponse("rad", (it.conversionValue.trim().toDouble()*0.001).toString()))
                                unitActivityList.add(UnitActivityModelResponse("′", (it.conversionValue.trim().toDouble() * 3.43775).toString()))
                                unitActivityList.add(UnitActivityModelResponse("″", (it.conversionValue.trim().toDouble()*206.265).toString()))
                        ...
                        viewModel.weightResponse.observe(this@DegreeActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("°", (it.conversionValue.trim().toDouble() *0.0166667).toString()))
                                unitActivityList.add(UnitActivityModelResponse("rad", (it.conversionValue.trim().toDouble()*0.000290888).toString()))
                                unitActivityList.add(UnitActivityModelResponse("mrad", (it.conversionValue.trim().toDouble() * 0.290888).toString()))
                                unitActivityList.add(UnitActivityModelResponse("″", (it.conversionValue.trim().toDouble()*60).toString()))
                            } else {
                                unitActivityList.add(UnitActivityModelResponse("°", ""))
                                unitActivityList.add(UnitActivityModelResponse("rad", ""))
                        ...
                        viewModel.weightResponse.observe(this@DegreeActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("°", (it.conversionValue.trim().toDouble() *0.000277778).toString()))
                                unitActivityList.add(UnitActivityModelResponse("rad", (it.conversionValue.trim().toDouble()*4.8481e-6).toString()))
                                unitActivityList.add(UnitActivityModelResponse("mrad", (it.conversionValue.trim().toDouble() * 0.00484814).toString()))
                                unitActivityList.add(UnitActivityModelResponse(",", (it.conversionValue.trim().toDouble()*0.0166667).toString()))
