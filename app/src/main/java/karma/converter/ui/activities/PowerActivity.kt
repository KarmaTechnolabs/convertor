...
class PowerActivity: BaseActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.header.toolbar.text = resources.getString(R.string.power)
        ...
        viewModel.weightResponse.observe(this) {
            ...
            if (it.conversionValue != "") {
                unitActivityList.add(UnitActivityModelResponse("kW", (it.conversionValue.trim().toDouble() *0.001).toString()))
                unitActivityList.add(UnitActivityModelResponse("HP", (it.conversionValue.trim().toDouble()*0.00134102).toString()))


            } else {
                unitActivityList.add(UnitActivityModelResponse("kW", ""))
                unitActivityList.add(UnitActivityModelResponse("HP", ""))
            ...
            callback = object : PickerLayoutManager.OnItemSelectedListener {
                override fun onItemSelected(layoutPosition: Int) {
                    ...
                    if(layoutPosition == 0) {
                        ...
                        viewModel.weightResponse.observe(this@PowerActivity) {
                            ...
                            unitActivityAdapter?.clear()
                            unitActivityAdapter?.setClickListener(this@PowerActivity)
                            binding.unitRecycler.adapter = unitActivityAdapter
                            unitActivityAdapter?.setItems(unitActivityList)
                        ...
                        viewModel.weightResponse.observe(this@PowerActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("watt", (it.conversionValue.trim().toDouble() *1000).toString()))
                                unitActivityList.add(UnitActivityModelResponse("HP", (it.conversionValue.trim().toDouble()*1.34102).toString()))

                            } else {
                                unitActivityList.add(UnitActivityModelResponse("watt", ""))
                                unitActivityList.add(UnitActivityModelResponse("HP", ""))
                        ...
                        viewModel.weightResponse.observe(this@PowerActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("watt", (it.conversionValue.trim().toDouble() *745.7).toString()))
                                unitActivityList.add(UnitActivityModelResponse("kW", (it.conversionValue.trim().toDouble()*0.7457).toString()))
