...
class SoundActivity : BaseActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.header.toolbar.text = resources.getString(R.string.sound)
        ...
        viewModel.weightResponse.observe(this) {
            ...
            if (it.conversionValue != "") {
                unitActivityList.add(UnitActivityModelResponse("B", (it.conversionValue.trim().toDouble() * 0.1).toString()))
                unitActivityList.add(UnitActivityModelResponse("Np", (it.conversionValue.trim().toDouble()*0.1151277918 ).toString()))

            } else {
                unitActivityList.add(UnitActivityModelResponse("B", ""))
                unitActivityList.add(UnitActivityModelResponse("Np", ""))
            }
            ...
            callback = object : PickerLayoutManager.OnItemSelectedListener {
                override fun onItemSelected(layoutPosition: Int) {
                    ...
                    if(layoutPosition == 0) {
                        ...
                        viewModel.weightResponse.observe(this@SoundActivity) {
                            ...
                            unitActivityAdapter?.clear()
                            unitActivityAdapter?.setClickListener(this@SoundActivity)
                            binding.unitRecycler.adapter = unitActivityAdapter
                            unitActivityAdapter?.setItems(unitActivityList)
                        ...
                        viewModel.weightResponse.observe(this@SoundActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("dB", (it.conversionValue.trim().toDouble() * 10).toString()))
                                unitActivityList.add(UnitActivityModelResponse("Np", (it.conversionValue.trim().toDouble()*1.151277918 ).toString()))

                            } else {
                                unitActivityList.add(UnitActivityModelResponse("dB", ""))
                                unitActivityList.add(UnitActivityModelResponse("Np", ""))
                        ...
                        viewModel.weightResponse.observe(this@SoundActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("dB", (it.conversionValue.trim().toDouble() *8.68).toString()))
                                unitActivityList.add(UnitActivityModelResponse("B", (it.conversionValue.trim().toDouble()*0.8685889638).toString()))
