...
class SpeedActivity: BaseActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.header.toolbar.text = resources.getString(R.string.speed)
        ...
        viewModel.weightResponse.observe(this) {
            ...
            if (it.conversionValue != "") {
                unitActivityList.add(UnitActivityModelResponse("mph", (it.conversionValue.trim().toDouble() *0.621371).toString()))
                unitActivityList.add(UnitActivityModelResponse("ft/s", (it.conversionValue.trim().toDouble()*0.911344).toString()))
                unitActivityList.add(UnitActivityModelResponse("m/s", (it.conversionValue.trim().toDouble()*0.277778).toString()))



            } else {
                unitActivityList.add(UnitActivityModelResponse("mph", ""))
                unitActivityList.add(UnitActivityModelResponse("ft/s", ""))
                unitActivityList.add(UnitActivityModelResponse("m/s", ""))
            ...
            callback = object : PickerLayoutManager.OnItemSelectedListener {
                override fun onItemSelected(layoutPosition: Int) {
                    ...
                    if(layoutPosition == 0) {
                        ...
                        viewModel.weightResponse.observe(this@SpeedActivity) {
                            ...
                            unitActivityAdapter?.clear()
                            unitActivityAdapter?.setClickListener(this@SpeedActivity)
                            binding.unitRecycler.adapter = unitActivityAdapter
                            unitActivityAdapter?.setItems(unitActivityList)
                        ...
                        viewModel.weightResponse.observe(this@SpeedActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("km/h", (it.conversionValue.trim().toDouble() *1.60934).toString()))
                                unitActivityList.add(UnitActivityModelResponse("ft/s", (it.conversionValue.trim().toDouble()*1.46667).toString()))
                                unitActivityList.add(UnitActivityModelResponse("m/s", (it.conversionValue.trim().toDouble()*0.44704).toString()))

                            } else {
                                unitActivityList.add(UnitActivityModelResponse("km/h", ""))
                                unitActivityList.add(UnitActivityModelResponse("ft/s", ""))
                                unitActivityList.add(UnitActivityModelResponse("m/s", ""))
                        ...
                        viewModel.weightResponse.observe(this@SpeedActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("km/h", (it.conversionValue.trim().toDouble() *1.09728).toString()))
                                unitActivityList.add(UnitActivityModelResponse("mph", (it.conversionValue.trim().toDouble()*0.681818).toString()))
                                unitActivityList.add(UnitActivityModelResponse("m/s", (it.conversionValue.trim().toDouble()*0.3048).toString()))
                        ...
                        viewModel.weightResponse.observe(this@SpeedActivity) {
                            ...
                            unitActivityList.clear()
                            if (it.conversionValue != "") {
                                unitActivityList.add(UnitActivityModelResponse("km/h", (it.conversionValue.trim().toDouble() *3.6).toString()))
                                unitActivityList.add(UnitActivityModelResponse("mph", (it.conversionValue.trim().toDouble()*2.23694).toString()))
                                unitActivityList.add(UnitActivityModelResponse("ft/s", (it.conversionValue.trim().toDouble()*3.28084).toString()))
                            } else {
